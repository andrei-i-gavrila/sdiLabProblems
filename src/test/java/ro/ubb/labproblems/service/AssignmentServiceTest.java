...
public class AssignmentServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        assignmentService = new AssignmentService(assignmentRepository, studentRepository);
        problemService = new ProblemService(problemRepository, assignmentRepository);
        studentService = new StudentService(studentRepository, assignmentRepository);
